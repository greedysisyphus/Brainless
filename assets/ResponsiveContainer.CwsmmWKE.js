import{j as n}from"./index.fRcar_uV.js";const u=({children:t,className:e="",maxWidth:r="container-custom",padding:s="py-4 sm:py-6 lg:py-8",center:a=!0})=>n.jsx("div",{className:`${r} ${s} ${a?"mx-auto":""} ${e}`,children:t}),g=({children:t,className:e="",padding:r="p-4 sm:p-6",hover:s=!0})=>n.jsx("div",{className:`
