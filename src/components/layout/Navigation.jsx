...
function Navigation() {
  ...
  if (isLoading) {
    return (
      <nav className="bg-surface sticky top-0 sm:top-[133px] md:top-[145px] z-50 shadow-lg">
  ...
  return (
    <nav className="bg-surface/60 backdrop-blur-xl sticky top-0 sm:top-[133px] md:top-[145px] z-50 shadow-xl border-b border-white/10 overflow-visible">
